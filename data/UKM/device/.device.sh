...
#Unofficial
	...
	g2|galbi|ls980|vs980|d80?|*m8*|honami|C6943|C690?|togari|C68??|shamu|d2*|jflte*|klte*)
		CONFIG="hammerhead";; #g2|galbi|ls980|vs980|d80x = LG G2, *m8* = HTC One M8, honami|C6943|C690x = Sony Xperia Z1, 
